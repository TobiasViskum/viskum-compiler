...
This will most likely be implemented (almost 100%), and it doesn't need to be explained what it is.
Genetics should be able to be used in all places you could imagine, like Rust genetics.
