    ...
    where 'ctx: 'ast, 'ast: 'b, E: ResolverHandle<'ctx, 'ast, AstResolved>
{
    ...
    //     fn set_fn_type_signature<'ctx, 'ast, 'b, E>(
    //         ast_visitor: &mut AstTypeChecker<'ctx, 'ast, 'b, E>,
    //         fn_item: &'ast FnItem<'ast>
    //     )
    //         where E: ResolverHandle<'ctx, 'ast, AstResolved>
    //     {
    //         let fn_def_id = ast_visitor.resolver_handle.get_def_id_from_node_id(
    //             fn_item.ident_node.ast_node_id
    //         );
    //         let ret_ty = fn_item.return_ty
    //             .map(|ty_expr|
    //                 type_from_typing(
    //                     &ty_expr,
    //                     ast_visitor.trait_impl_context,
    //                     ast_visitor.resolver_handle,
    //                     fn_item.item_type,
    //                     &ast_visitor.lexical_context_to_parent_lexical_context
    //                 )
    //             )
    //             .unwrap_or(VOID_TY);
    ...
    //             () => {
    //                 ast_visitor.trait_impl_context.expect("Expected impl context to be set").implementor_def_id
    //             };
    //         }
    ...
    //                 ast_visitor.resolver_handle.set_type_to_node_id(ident_node.ast_node_id, ty);
    ...
    //             )
    //         );
    //         ast_visitor.resolver_handle.set_namebinding_to_def_id(fn_def_id, name_binding);
    //     }

    //     for item_stmt in item_iter {
    //         match item_stmt {
    //             ItemStmt::FnItem(fn_item) => {
    //                 set_fn_type_signature(self, fn_item);
    //             }
    ...
    //                 self.begin_impl_context(TraitImplId::new(def_id, None));
    ...
    fn visit_ident_expr(&mut self, ident_node: &'ast IdentNode) -> Self::Result {
        ...
        //         mutability
        //     );
        //     self.resolver_handle.set_type_to_node_id(ident_node.ast_node_id, ident_ty);
        //     ident_ty
        // } else if
        //     let Some(def_id) = self.resolver_handle.lookup_ident_declaration(
        //         Symbol::from_node_id(ident_node.ast_node_id),
        ...
        //     )
        // {
        //     match self.resolver_handle.get_namebinding_from_def_id(def_id).kind {
        //         NameBindingKind::Fn(_, _, _) => {}
        ...
        //     )
        // {
        //     let ty = Ty::AtdConstructer(implementor_def_id);
        //     self.resolver_handle.set_type_to_node_id(ident_node.ast_node_id, ty);
    ...
    // fn visit_impl_item(&mut self, impl_item: &'ast ImplItem<'ast>) -> Self::Result {
    //     let def_id = self.resolver_handle.get_def_id_from_node_id(impl_item.ident_node.ast_node_id);
    ...
    // fn visit_typedef_item(&mut self, typedef_item: &'ast TypedefItem<'ast>) -> Self::Result {
    //     let name_binding = {
    //         let symbol = Symbol::from_node_id(typedef_item.ident_node.ast_node_id);
    ...
    //         self.resolver_handle.set_type_to_node_id(typedef_item.ident_node.ast_node_id, ty);
    //     } else {
    ...
    //             let def_id = self.resolver_handle.get_def_id_from_node_id(arg.ident.ast_node_id);
    ...
    //                 &self.lexical_context_to_parent_lexical_context
    //             );
    //             self.resolver_handle.set_type_to_node_id(arg.ident.ast_node_id, res_ty);
    ...
    //         // self.resolver_handle.start_context();
    //         {
    ...
    //             // self.resolver_handle.end_context();
    //             self.fn_ret_ty = prev_ret_ty;
    //         }

    //         let symbol = Symbol::from_node_id(fn_item.ident_node.ast_node_id);
    //         if symbol.get() == "main" && self.resolver_handle.is_main_scope() {
    //             if !self.resolver_handle.set_main_fn(fn_item) {
    //                 panic!(
    //                     "Duplicate definitions of entry point `main` in global scope (report error)"
    //                 );
    ...
    // fn visit_enum_item(&mut self, enum_item: &'ast EnumItem<'ast>) -> Self::Result {
    //     let def_id = {
    //         let enum_def_id = self.resolver_handle.get_def_id_from_node_id(
    //             enum_item.ident_node.ast_node_id
    //         );
    ...
    //         let name_binding = NameBinding::new(
    //             NameBindingKind::Adt(Adt::Enum(self.resolver_handle.alloc_vec(variants)))
    //         );

    //         self.resolver_handle.set_namebinding_to_def_id(enum_def_id, name_binding);
    ...
    //             self.resolver_handle.set_type_to_node_id(field.ident.ast_node_id, res_ty);
    ...
    //         let name_binding = NameBinding::new(
    //             NameBindingKind::Adt(
    //                 Adt::Struct(self.resolver_handle.alloc_vec(struct_binding_fields))
    //             )
    //         );
