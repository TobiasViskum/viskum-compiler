...
@.str.0.35 = private unnamed_addr constant [3 x i8] c"ms\00"
...
define [12 x i8] @new0_15(i32 noundef %0, i32 noundef %1, i32 noundef %2) {
...
4:
    ...
    %6 = sext i8 3 to i32
    %7 = sext i8 4 to i32
    %8 = call [12 x i8] (i32, i32, i32) @new0_15(i32 noundef %5, i32 noundef %6, i32 noundef %7)
    store [12 x i8] %8, ptr %1
    %9 = call i32 (ptr) @sum0_32(ptr noundef %1)
    store i32 %9, ptr %2
    call void (ptr) @dbg1_540(ptr noundef %1)
    %10 = load i32, ptr %2
    %11 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.513, i32 noundef %10)
    %12 = call i32 () @doSomething0_50()
...
define i32 @sum0_32(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
