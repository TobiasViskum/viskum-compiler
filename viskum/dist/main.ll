...
@.str.1.498 = private unnamed_addr constant [8 x i8] c"YAYY%d\0A\00"
@.str.1.144 = private unnamed_addr constant [18 x i8] c"Len: %d, Cap: %d\0A\00"
@.str.1.464 = private unnamed_addr constant [30 x i8] c"Hello, value is: %d + 1 = %d\0A\00"
@.str.1.424 = private unnamed_addr constant [3 x i8] c"ms\00"
@.str.1.528 = private unnamed_addr constant [24 x i8] c"doSomething result: %d\0A\00"
@.str.1.460 = private unnamed_addr constant [21 x i8] c"Hello, value is: %d\0A\00"
...
@.str.1.595 = private unnamed_addr constant [34 x i8] c"\1B[31mAssert: %d != %d, Err: '%s'\0A\00"
@.str.1.580 = private unnamed_addr constant [5 x i8] c"\1B[0m\00"
@.str.1.556 = private unnamed_addr constant [31 x i8] c"Point { x: %d, y: %d, z: %d }\0A\00"
@.str.1.314 = private unnamed_addr constant [2 x i8] c"\0A\00"
@.str.1.281 = private unnamed_addr constant [10 x i8] c"Cap = %d\0A\00"
@.str.1.524 = private unnamed_addr constant [18 x i8] c"Sum of point: %d\0A\00"
@.str.1.614 = private unnamed_addr constant [21 x i8] c"\1B[32mTest %d passed\0A\00"
@.str.1.681 = private unnamed_addr constant [1 x i8] c"\00"
...
4:
    ...
    store i32 %9, ptr %2
    call void (ptr) @dbg1_553(ptr noundef %1)
    %10 = load i32, ptr %2
    %11 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.524, i32 noundef %10)
    %12 = call i32 () @doSomething0_43()
    %13 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.528, i32 noundef %12)
    call void () @runTests1_445()
...
define void @printReset1_577(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
    %4 = call i32 (ptr) @printf(ptr noundef @.str.1.580)
    ret void
}
...
define void @testFn1_487(i32 noundef %0, i32 noundef %1) {
...
6:
    ...
    %13 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.498, i32 noundef %12)
    ret void
}
...
define void @printTestSucces1_609(ptr noundef %0, i32 noundef %1) {
...
5:
    ...
    store i32 %1, ptr %4
    %6 = load i32, ptr %4
    %7 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.614, i32 noundef %6)
    %8 = load ptr, ptr %3
    call void (ptr) @printReset1_577(ptr noundef %8)
    ret void
}

define void @dbg1_553(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
    ...
    %10 = getelementptr inbounds i8, ptr %9, i64 8
    %11 = load i32, ptr %10
    %12 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.556, i32 noundef %5, i32 noundef %8, i32 noundef %11)
    ret void
}

define [20 x i8] @new1_632() {
    %1 = alloca [20 x i8], align 1
    br label %2
2:
    %3 = call [16 x i8] () @new1_128()
    store [16 x i8] %3, ptr %1
    %4 = call [0 x i8] () @new1_572()
...
define i32 @getTestCount1_728(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
...
define void @testPush1_660(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
    ...
    %10 = load i32, ptr %9
    %11 = sext i8 2 to i32
    call void (ptr, i32, i32, ptr) @assertInt1_583(ptr noundef %7, i32 noundef %10, i32 noundef %11, ptr noundef @.str.1.681)
    %12 = load ptr, ptr %2
    %13 = getelementptr inbounds i8, ptr %12, i64 16
    %14 = load ptr, ptr %2
    %15 = call i32 (ptr) @getTestCount1_728(ptr noundef %14)
    call void (ptr, i32) @printTestSucces1_609(ptr noundef %13, i32 noundef %15)
    ret void
}

define void @testPop1_694(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
    ...
    call void (ptr, i32, i32, ptr) @assertInt1_583(ptr noundef %7, i32 noundef %9, i32 noundef %10, ptr noundef @.str.1.681)
    %11 = load ptr, ptr %2
    %12 = getelementptr inbounds i8, ptr %11, i64 16
    %13 = load ptr, ptr %2
    %14 = call i32 (ptr) @getTestCount1_728(ptr noundef %13)
    call void (ptr, i32) @printTestSucces1_609(ptr noundef %12, i32 noundef %14)
    ret void
}

define void @assertInt1_583(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) {
...
13:
    ...
    %15 = load i32, ptr %7
    %16 = load ptr, ptr %8
    %17 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.595, i32 noundef %14, i32 noundef %15, ptr noundef %16)
    %18 = load ptr, ptr %5
    call void (ptr) @printReset1_577(ptr noundef %18)
    %19 = sext i8 1 to i32
...
define void @runTests1_649(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
    %4 = load ptr, ptr %2
    call void (ptr) @testPush1_660(ptr noundef %4)
    %5 = load ptr, ptr %2
    call void (ptr) @testPop1_694(ptr noundef %5)
    ret void
}
...
12:
    ...
    store i32 %14, ptr %2
    %15 = load i32, ptr %2
    %16 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.460, i32 noundef %15)
    %17 = load i32, ptr %2
    %18 = load i32, ptr %2
    %19 = sext i8 1 to i32
    %20 = add nsw i32 %18, %19
    %21 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.464, i32 noundef %17, i32 noundef %20)
    store i32 %21, ptr %5
    br label %22
22:
    %23 = call [20 x i8] () @new1_632()
    store [20 x i8] %23, ptr %3
    call void (ptr) @runTests1_649(ptr noundef %3)
    ret void
}
