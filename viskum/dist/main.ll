...
@.str.1.685 = private unnamed_addr constant [1 x i8] c"\00"
...
@.str.1.560 = private unnamed_addr constant [31 x i8] c"Point { x: %d, y: %d, z: %d }\0A\00"
@.str.1.528 = private unnamed_addr constant [18 x i8] c"Sum of point: %d\0A\00"
@.str.1.296 = private unnamed_addr constant [11 x i8] c"[%d] = %d\0A\00"
@.str.1.275 = private unnamed_addr constant [10 x i8] c"Len = %d\0A\00"
@.str.1.584 = private unnamed_addr constant [5 x i8] c"\1B[0m\00"
@.str.1.144 = private unnamed_addr constant [18 x i8] c"Len: %d, Cap: %d\0A\00"
@.str.1.599 = private unnamed_addr constant [34 x i8] c"\1B[31mAssert: %d != %d, Err: '%s'\0A\00"
@.str.1.618 = private unnamed_addr constant [21 x i8] c"\1B[32mTest %d passed\0A\00"
@.str.1.424 = private unnamed_addr constant [3 x i8] c"ms\00"
@.str.1.502 = private unnamed_addr constant [8 x i8] c"YAYY%d\0A\00"
...
@.str.1.532 = private unnamed_addr constant [24 x i8] c"doSomething result: %d\0A\00"
...
define void @runTests1_653(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
    %4 = load ptr, ptr %2
    call void (ptr) @testPush1_664(ptr noundef %4)
    %5 = load ptr, ptr %2
    call void (ptr) @testPop1_698(ptr noundef %5)
    ret void
}

define void @printReset1_581(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
    %4 = call i32 (ptr) @printf(ptr noundef @.str.1.584)
    ret void
}
...
define void @thisWillError1_493(i32 noundef %0, i32 noundef %1) {
...
6:
    ...
    %7 = load i8, ptr %5
    %8 = add nsw i8 %7, 1
    %9 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.502, i8 noundef %8)
    ret void
}

define [20 x i8] @new1_636() {
    %1 = alloca [20 x i8], align 1
    br label %2
2:
    %3 = call [16 x i8] () @new1_128()
    store [16 x i8] %3, ptr %1
    %4 = call [0 x i8] () @new1_576()
...
define void @dbg1_557(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
    ...
    %10 = getelementptr inbounds i8, ptr %9, i64 8
    %11 = load i32, ptr %10
    %12 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.560, i32 noundef %5, i32 noundef %8, i32 noundef %11)
    ret void
}

define void @assertInt1_587(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) {
...
13:
    ...
    %15 = load i32, ptr %7
    %16 = load ptr, ptr %8
    %17 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.599, i32 noundef %14, i32 noundef %15, ptr noundef %16)
    %18 = load ptr, ptr %5
    call void (ptr) @printReset1_581(ptr noundef %18)
    %19 = sext i8 1 to i32
...
4:
    ...
    store i32 %9, ptr %2
    call void (ptr) @dbg1_557(ptr noundef %1)
    %10 = load i32, ptr %2
    %11 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.528, i32 noundef %10)
    %12 = call i32 () @doSomething0_43()
    %13 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.532, i32 noundef %12)
...
define void @testPop1_698(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
    ...
    call void (ptr, i32, i32, ptr) @assertInt1_587(ptr noundef %7, i32 noundef %9, i32 noundef %10, ptr noundef @.str.1.685)
    %11 = load ptr, ptr %2
    %12 = getelementptr inbounds i8, ptr %11, i64 16
    %13 = load ptr, ptr %2
    %14 = call i32 (ptr) @getTestCount1_732(ptr noundef %13)
    call void (ptr, i32) @printTestSucces1_613(ptr noundef %12, i32 noundef %14)
    ret void
}

define void @testPush1_664(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
    ...
    %10 = load i32, ptr %9
    %11 = sext i8 2 to i32
    call void (ptr, i32, i32, ptr) @assertInt1_587(ptr noundef %7, i32 noundef %10, i32 noundef %11, ptr noundef @.str.1.685)
    %12 = load ptr, ptr %2
    %13 = getelementptr inbounds i8, ptr %12, i64 16
    %14 = load ptr, ptr %2
    %15 = call i32 (ptr) @getTestCount1_732(ptr noundef %14)
    call void (ptr, i32) @printTestSucces1_613(ptr noundef %13, i32 noundef %15)
    ret void
}

define void @printTestSucces1_613(ptr noundef %0, i32 noundef %1) {
...
5:
    ...
    store i32 %1, ptr %4
    %6 = load i32, ptr %4
    %7 = call i32 (ptr, ...) @printf(ptr noundef @.str.1.618, i32 noundef %6)
    %8 = load ptr, ptr %3
    call void (ptr) @printReset1_581(ptr noundef %8)
    ret void
}

define i32 @getTestCount1_732(ptr noundef %0) {
    %2 = alloca [8 x i8], align 8
    br label %3
3:
    store ptr %0, ptr %2
...
12:
    ...
    br label %22
22:
    %23 = call [20 x i8] () @new1_636()
    store [20 x i8] %23, ptr %3
    call void (ptr) @runTests1_653(ptr noundef %3)
    ret void
}
